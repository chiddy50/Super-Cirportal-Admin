...
import nuxt_plugin_plugin_51216733 from 'nuxt_plugin_plugin_51216733' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_bootstrapvue_f40b0ff6 from 'nuxt_plugin_bootstrapvue_f40b0ff6' // Source: .\\bootstrap-vue.js (mode: 'all')
import nuxt_plugin_pluginclient_0e45f669 from 'nuxt_plugin_pluginclient_0e45f669' // Source: .\\content\\plugin.client.js (mode: 'client')
import nuxt_plugin_pluginserver_73ff67f1 from 'nuxt_plugin_pluginserver_73ff67f1' // Source: .\\content\\plugin.server.js (mode: 'server')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_51216733 === 'function') {
    await nuxt_plugin_plugin_51216733(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_f40b0ff6 === 'function') {
    await nuxt_plugin_bootstrapvue_f40b0ff6(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_0e45f669 === 'function') {
    await nuxt_plugin_pluginclient_0e45f669(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_73ff67f1 === 'function') {
    await nuxt_plugin_pluginserver_73ff67f1(app.context, inject)
  }
